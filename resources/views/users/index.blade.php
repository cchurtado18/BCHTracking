...
<div class="users-page">
    <x-module-banner section="Administración" current="Usuarios" title="Usuarios PrimeTrack" subtitle="Crear y gestionar usuarios del sistema. En cada ficha se marcan los módulos y opciones permitidas.">
        <x-slot:icon>
