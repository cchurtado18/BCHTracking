...
.users-hero-btn:hover { background: #ecfdf5; color: #059669; border-color: #fff; }
.users-alert { padding: 0.75rem 1rem; border-radius: 0.5rem; margin-bottom: 1rem; font-size: 0.875rem; }
.users-alert-success { background: #ecfdf5; border: 1px solid #a7f3d0; color: #065f46; }
...
.users-stat-total { border-left: 4px solid #059669; }
.users-stat-admin { border-left: 4px solid #059669; }
...
.users-btn-outline-primary { background: #fff; color: #059669; border-color: #059669; }
.users-btn-outline-primary:hover { background: #d1fae5; color: #047857; }
...
.users-table-header { background: linear-gradient(135deg, #047857 0%, #059669 50%, #10b981 100%); }
...
.users-badge-admin { background: #d1fae5; color: #047857; }
...
.users-pagination-links a:hover { background: #f3f4f6; color: #059669; }
.users-pagination-links .disabled span { background: #f9fafb; color: #9ca3af; }
.users-pagination-links .active span { background: #059669; color: #fff; border-color: #059669; }
</style>
@endsection
