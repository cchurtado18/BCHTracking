...
<div class="packages-page">
    <x-module-banner section="General" current="Fichaje" title="Fichaje PrimeTrack" subtitle="Use Iniciar al comenzar la jornada, Break para pausas y Salida al terminar. Horas mostradas en {{ $tz }}.">
        <x-slot:icon>
