    ...
    <header class="cons-hero">
        <div class="cons-hero-inner">
            <div class="cons-hero-text">
                <h1 class="cons-hero-title">Crear Consolidación (Saco)</h1>
                <p class="cons-hero-subtitle">Crea un nuevo saco y selecciona los preregistros que enviarás. Puedes elegir un solo preregistro si envías una caja por separado (saco unitario).</p>
            </div>
            <a href="{{ route('consolidations.index') }}" class="cons-hero-btn">← Volver a consolidaciones</a>
        </div>
    </header>
