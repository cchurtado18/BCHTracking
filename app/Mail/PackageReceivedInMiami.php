...
class PackageReceivedInMiami extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Paquete '.$this->packageCode.' recibido en Miami — PrimeTrack Group',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.package-received-miami',
        );
    }
}
